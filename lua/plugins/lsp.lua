		...
		config = function()
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					map_i("<C-h>", vim.lsp.buf.signature_help, "Signature [H]elp")
			...
			-- local goto_def_handler = vim.lsp.handlers["textDocument/definition"]
			-- vim.print("def handler", goto_def_handler)
			-- vim.lsp.handlers["textDocument/definition"] = function(err, result, context, config)
			-- 	vim.print("goto def", err, result, context, config)
			-- 	goto_def_handler(err, result, context, config)
			-- end
		end,
	},
	-- Autoformat
